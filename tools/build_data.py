...
# data.js is the file that gets deployed, and the one most likely to be lifted on
# its own, so the notices travel on its face rather than only in DATA-LICENSES.md.
HEADER = """\
// Generated by tools/build_data.py - do not edit by hand.
// Source of truth: data/*.geojson
//
// Bundled data, and the terms it keeps:
//   Station and line history   fr.wikipedia.org, CC BY-SA
//   Water                      Apur, PLAN EAU, ODbL 1.0
//   Parks                      Ville de Paris (espaces_verts), ODbL, and
//                              (c) OpenStreetMap contributors, ODbL
//
// Attribution and share-alike apply to all of it. Full terms and sources in
// DATA-LICENSES.md. This file combines CC BY-SA and ODbL data, whose share-alike
// regimes do not compose: to reuse the data, take it from data/, where each
// source stays separate under its own terms.
"""
