...
window.METRO_I18N = {
  ...
  fr: {
    ...
    "subtitle": "L'expansion du réseau, 1900 – 2026, et ce qui vient",
    ...
    "tip.since": "depuis %s",
    "tip.planned": "en projet · ouverture prévue en %s",
    "year.planned": "projet",
    "legend.planned": "En pointillé : lignes en projet, non ouvertes.",
    "tip.range": "%s–%s",
  ...
  en: {
    ...
    "subtitle": "How the network grew, 1900 – 2026, and what comes next",
    ...
    "tip.since": "since %s",
    "tip.planned": "planned · opening expected %s",
    "year.planned": "planned",
    "legend.planned": "Dashed: planned lines, not yet open.",
    "tip.range": "%s–%s",
    "tip.today": "today: %s",
    "tip.was": "formerly: %s",
